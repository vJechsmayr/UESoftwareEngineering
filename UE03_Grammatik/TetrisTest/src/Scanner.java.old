...
public class Scanner {
	...
	static {
		...
		for (int i = 66; i <= 90; ++i) start.set(i, 2);
		...
		loop: for (;;) {
			switch (state) {
				...
				case 2:
					...
					if (ch >= '-' && ch <= '.' || ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'z') {AddCh(); state = 2; break;}
				...
				case 8:
					recEnd = pos; recKind = 2;
					if (ch >= '-' && ch <= '.' || ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'b' || ch >= 'd' && ch <= 'z') {AddCh(); state = 2; break;}
					else if (ch == 'c') {AddCh(); state = 9; break;}
					else {t.kind = 2; break loop;}
				case 9:
					recEnd = pos; recKind = 2;
					if (ch >= '-' && ch <= '.' || ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'b' || ch >= 'd' && ch <= 'z') {AddCh(); state = 2; break;}
					else if (ch == 'c') {AddCh(); state = 10; break;}
					else {t.kind = 2; break loop;}
				case 10:
					recEnd = pos; recKind = 2;
					if (ch >= '-' && ch <= '.' || ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'n' || ch >= 'p' && ch <= 'z') {AddCh(); state = 2; break;}
					else if (ch == 'o') {AddCh(); state = 11; break;}
					else {t.kind = 2; break loop;}
				case 11:
					recEnd = pos; recKind = 2;
					if (ch >= '-' && ch <= '.' || ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 't' || ch >= 'v' && ch <= 'z') {AddCh(); state = 2; break;}
					else if (ch == 'u') {AddCh(); state = 12; break;}
					else {t.kind = 2; break loop;}
				case 12:
					recEnd = pos; recKind = 2;
					if (ch >= '-' && ch <= '.' || ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'm' || ch >= 'o' && ch <= 'z') {AddCh(); state = 2; break;}
					else if (ch == 'n') {AddCh(); state = 13; break;}
					else {t.kind = 2; break loop;}
				case 13:
					recEnd = pos; recKind = 2;
					if (ch >= '-' && ch <= '.' || ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 's' || ch >= 'u' && ch <= 'z') {AddCh(); state = 2; break;}
					else if (ch == 't') {AddCh(); state = 14; break;}
					else {t.kind = 2; break loop;}
				case 14:
					recEnd = pos; recKind = 2;
					if (ch >= '-' && ch <= '.' || ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'z') {AddCh(); state = 2; break;}
